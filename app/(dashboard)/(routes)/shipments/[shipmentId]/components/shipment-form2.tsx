                ...
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
                    <div className="rounded-t bg-white mb-0 px-6 py-6">
                        <div className="text-center flex justify-between">
                            <h6 className="text-blueGray-700 text-xl font-bold">შეკვეთის განთავსება</h6>
                            <button
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="relative w-full mb-3">
                                                        ...
                                                        >გვარი</FormLabel>
                                                        <FormControl className="relative rounded-md shadow-sm">
                                                            <Input disabled={loading} placeholder="გვარი" {...field} className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="relative w-full mb-3">
                                                        ...
                                                        >მისამართი</FormLabel>
                                                        <FormControl className="relative rounded-md shadow-sm">
                                                            <Input disabled={loading} placeholder="მისამართი" {...field} className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                                        ...
                                        <div className="relative w-full mb-3">
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="relative w-full mb-3">
                                                        <FormLabel className="block uppercase text-blueGray-600 text-xs font-bold mb-2"
                                                        >ტელეფონის ნომერი</FormLabel>
                                                        <FormControl className="relative rounded-md shadow-sm">
                                                            <Input disabled={loading} placeholder="ტელეფონის ნომერი" {...field} className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                                    ...
                                    <div className="w-full lg:w-4/12 px-4">
                                        <div className="relative w-full mb-3">
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="relative w-full mb-3">
                                                        <FormLabel className=" block uppercase text-blueGray-600 text-xs font-bold mb-2">სტატუსი</FormLabel>
                                                        <FormControl className="relative rounded-md shadow-sm">
                                                            <Select
                                                                value={field.value}
                                    ...
                                    <div className="w-full lg:w-4/12 px-4">
                                        <div className="relative w-full mb-3">
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="relative w-full mb-3">
                                                        <FormLabel className="block uppercase text-blueGray-600 text-xs font-bold mb-2">საწყობშია ნივთი?</FormLabel>
                                                        <FormControl>
                                                            <Select
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem className="relative w-full mb-3">
                                                        ...
                                                        >კომენტარი</FormLabel>
                                                        <FormControl className="relative rounded-md shadow-sm">
                                                            <Input disabled={loading} placeholder="დაწერე კომენტარი.." {...field} className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
