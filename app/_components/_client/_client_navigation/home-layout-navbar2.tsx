...
export default function Header({ isSession }: { isSession: boolean }) {
    ...
    return (
        <div className={`fixed w-full bg-black text-white z-30 md:bg-opacity-90 transition duration-300 ease-in-out ${!top ? 'bg-gray-900 text-black backdrop-blur-sm shadow-lg' : ''}`}>
